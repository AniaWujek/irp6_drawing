...
if __name__ == '__main__':
	...
	if 	checkPoint(p0) and checkPoint(p1) and checkPoint(p2) and checkPoint(p3):
		...
		irpos.move_to_cartesian_pose(10.0, Pose(Point(p0[0], p0[1], p0[2]), irpos.get_cartesian_pose().orientation))	
		move.zjedzDoKartki(20.0)
		#~ irpos.move_rel_to_cartesian_pose(1.0, Pose(Point(0.0, 0.0, -0.005), Quaternion(0.0, 0.0, 0.0, 1.0)))	
		...
		#~ point0 = CartesianTrajectoryPoint(rospy.Duration(5.0), Pose(Point(p0[0], p0[1], z), irpos.get_cartesian_pose().orientation), Twist())
		point1 = CartesianTrajectoryPoint(rospy.Duration(5.0), Pose(Point(p1[0], p1[1], z), irpos.get_cartesian_pose().orientation), Twist())
		point2 = CartesianTrajectoryPoint(rospy.Duration(10.0), Pose(Point(p2[0], p2[1], z), irpos.get_cartesian_pose().orientation), Twist())
		point3 = CartesianTrajectoryPoint(rospy.Duration(15.0), Pose(Point(p3[0], p3[1], z), irpos.get_cartesian_pose().orientation), Twist())
		point4 = CartesianTrajectoryPoint(rospy.Duration(20.0), Pose(Point(p0[0], p0[1], z), irpos.get_cartesian_pose().orientation), Twist())
