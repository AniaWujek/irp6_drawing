...
if __name__ == '__main__':
	...
	#irpos.move_to_motor_position([-5.485220773167779, -13.670640432095986, -7.536680775961914, 151.30538538219162, 70.33868871754868, 771.9490052474305], 15.0)
	#2. rozszerz chytak
	#irpos.tfg_to_joint_position(0.07, 5.0)
	#3.idz na dol 2.0 N, 40 cm w dol
	irpos.move_rel_to_cartesian_pose_with_contact(20.0, Pose(Point(0.0, 0.0, 0.3), Quaternion(0.0, 0.0, 0.0, 0.0)), Wrench(Vector3(0.0,0.0,2.0),Vector3(0.0,0.0,0.0)))
	#lekko w gore
	#irpos.move_rel_to_cartesian_pose(10.0, Pose(Point(0.0, 0.0, 0.005), Quaternion(0.0, 0.0, 0.0, 0.0)))
	#lap
