...
if __name__ == '__main__':
	...
	irpos.move_rel_to_cartesian_pose(10.0, Pose(Point(0.05, 0.0, -0.1), Quaternion(0.0, 0.0, 0.0, 1.0)))
	
	#irpos.move_rel_to_cartesian_pose(8.0, Pose(Point(0.05, -0.05, 0.0), Quaternion(0.0, 0.0, 0.0, 1.0)))
	
	#irpos.move_to_joint_position([ 0, 0, -0.5 * math.pi, 0, 0.5 * math.pi, 0.5 * math.pi, -0.5 * math.pi], 10)
	...
	print irpos.get_cartesian_pose()
  	...
  	#irpos.move_rel_to_cartesian_pose(8.0, Pose(Point(0.0, 0.0, 0.0), Quaternion(0.0, 0.0, 0.0, 1.0)))
